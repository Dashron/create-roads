...
export declare function getFn<RepresentationFormat, Models, Auth>(models: {
    ownerId: number;
}, requestBody: unknown, requestMediaHandler: JSONRepresentation<RepresentationFormat, Models, Auth>, auth: Auth & {
    id: number;
}): void;
...
export declare function buildGetConfig<RepresentationFormat, Models, Auth>(tokenResolver: AuthScheme<Auth>, representationConstructor: JSONRepresentationConstructor<RepresentationFormat, Models, Auth>): ActionConfig;
export declare function buildGetListConfig<RepresentationFormat, Models, Auth>(tokenResolver: AuthScheme<Auth>, representationConstructor: JSONRepresentationConstructor<RepresentationFormat, Models, Auth>, collectionItemsResolver: ResolveArrayItems): ActionConfig;
...
export declare function buildPartialEditConfig<RepresentationFormat, Models, Auth>(tokenResolver: AuthScheme<Auth>, representationConstructor: JSONRepresentationConstructor<RepresentationFormat, Models, Auth>): ActionConfig;
...
export declare function buildAppendConfig<RepresentationFormat, Models, Auth>(tokenResolver: TokenResolver<Auth>, representationConstructor: JSONRepresentationConstructor<RepresentationFormat, Models, Auth>): ActionConfig;
...
export declare function buildDeleteConfig<RepresentationFormat, Models, Auth>(tokenResolver: AuthScheme<Auth>, representationConstructor: JSONRepresentationConstructor<RepresentationFormat, Models, Auth>): ActionConfig;
export {};
