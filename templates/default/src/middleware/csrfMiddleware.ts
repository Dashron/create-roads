 ...
 */
import { Context, Middleware, StoreValsMiddleware, ParseBodyMiddleware, CookieMiddleware, Response } from 'roads';
		...
		// don't do any of this on tests
			...
			this.isValidCSRFToken = () => {
				...
				try {
					...
					//	we just make sure that the tokens are signed with our secret, haven't expired,
					//  and contain the same user IDs between
