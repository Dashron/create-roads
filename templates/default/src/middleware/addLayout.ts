...
import { Response, Context, Middleware, StoreValsMiddleware } from 'roads';
...
export class ReactResponse extends Response {
	...
	constructor(body: JSX.Element, status?: number, headers?: Record<string, string | Array<string> | undefined>) {
...
export class JSONObjectResponse extends Response {
	...
	constructor(body: JSONObject, status?: number, headers?: Record<string, string | Array<string> | undefined>) {
		if (!headers) {
			headers = {};
		}
...
export type LayoutWrapper = (response: Response, data: Record<string, any>, context: Context) => string;
